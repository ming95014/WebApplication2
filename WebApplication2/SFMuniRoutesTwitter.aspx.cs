...
{
    public partial class SFMuniRoutesTwitter : System.Web.UI.Page
    {
        private string[] ArrRouts = {                           
                            "J-Church",
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                mv1.ActiveViewIndex = lbRoutes.SelectedIndex;
        }

        private void LoadRoutes()
        {
            foreach (string str in ArrRouts)
                lbRoutes.Items.Add(new ListItem(str));
        }
    }
}